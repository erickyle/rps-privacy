...
namespace rpsPluginBoilerplate\frontend;
 ...
 * @subpackage 			rps-plugin-boilerplate/frontend
...
class Frontend {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin->get_plugin_name(), plugin_dir_url( __FILE__ ) . 'css/frontend.css', array(), $this->plugin->get_plugin_version(), 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin->get_plugin_name(), plugin_dir_url( __FILE__ ) . 'js/frontend.js', array( 'jquery' ), $this->plugin->get_plugin_version(), false );
